          ...
          <tr key={booking._id}>
            <td>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="font-bold text-2xl">{booking.productName}</div>
                  <div className="text-sm ">Model : {booking.carModel} </div>
                </div>
              </div>
            </td>
            <td>Price : <span className='font-bold text-xl'> ${booking.productPrice}</span> </td>
            <td>
              {booking.paymentStatus === "unpaid" ? (
                ...
                <button className="bg-yellow-500 font-bold px-5 py-1 rounded opacity-60" disabled>
                  Paid
                </button>
              )}
            </td>
