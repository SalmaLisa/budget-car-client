        ...
        <tbody>
          {
            ...
            <td>
              ...
              <td>
                {product.saleStatus === "available" ?<p className="text-green-600 font-bold px-3 py-1 rounded">Available</p>:<p className="text-red-600 font-bold px-8 py-1 rounded">Sold</p>}
              
              
            </td>
              <td>
                {product.saleStatus === "available" && 
            <button className="bg-yellow-300 font-semibold px-3 py-1 rounded">Advertise</button>
                }
              </td>
              <td>
                  <button
